...
- (void)addConstraints {
    ...
    self.createdAt.text = [NSString stringWithFormat:@"%@",[self.serverUser createdAt]];
    ...
    constraints = [constraints arrayByAddingObjectsFromArray:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-70-[_userNameLabel(50)]-[_emailHeader(20)]-0-[_emailLabel(50)]-[_createdAt(50)]-50-[_logoutBtn(40)]" options:0 metrics:nil views:views]];
