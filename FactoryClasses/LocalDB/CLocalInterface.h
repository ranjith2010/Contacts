...
typedef void(^storeCDContactCompletionBlock)(BOOL result,NSError *error);
typedef void(^updateCDContactCompletionBlock)(BOOL result,NSError *error);
typedef void(^readAllCDContactsCompletionBlock)(NSArray *contacts,NSError *error);



typedef void(^storeCDUserComletionBlock)(BOOL result,NSError *error);
